        ...
        <DialogContent className="w-[95vw] sm:max-w-lg max-h-[95vh] overflow-y-auto p-4 sm:p-6 rounded-xl">
          ...
          <div className="text-center space-y-3 sm:space-y-4 py-2">
            ...
            <div className="pt-2">
              ...
              <a
                href="https://wa.me/56922318598?text=Hola,%20acabo%20de%20realizar%20una%20compra%20y%20tengo%20una%20consulta"
                target="_blank"
              ...
              >
                ...
                <span className="hidden sm:inline">WhatsApp:</span> +56 922 318 598
              </a>
            </div>
