...
const PAGE_ROUTE = "/eleganciapro";
const PRODUCT_ID = "LINO-PREMIUM-CO";
...
const LinoCO2 = () => {
  ...
  const finalPrice = basePrice; // upsell é grátis (presente)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="text-white">
            ...
            <p className="text-white/70 text-sm sm:text-base mb-5">
              Camisa de botones + pantalón en lino premium ultra fresco. Elegancia casual perfecta para el clima cálido, con envío rápido a toda Colombia.
            </p>
