            ...
            <div className="space-y-3 mb-6 sm:mb-8">
              <Dialog open={showCODForm} onOpenChange={setShowCODForm}>
                <DialogTrigger asChild>
                  <Button
                    size="lg"
                    className="w-full text-base sm:text-lg font-bold py-5 sm:py-7 bg-gradient-hero hover:shadow-glow transition-all flex flex-col items-center gap-1"
                  >
                    <span className="flex items-center">
                      <Gift className="w-5 h-5 sm:w-6 sm:h-6 mr-2" />
                      COMPRAR AHORA
                    </span>
                    <span className="text-sm sm:text-base font-semibold opacity-90">¡COMPRA 1 Y LLEVA 2!</span>
                  </Button>
                </DialogTrigger>
