...
import vestidoCorsetBranco2 from "@/assets/vestido-corset-branco-2.jpg";
import vestidoCorsetBranco3 from "@/assets/vestido-corset-branco-3.jpg";
import vestidoCorsetNegro1 from "@/assets/vestido-corset-negro-1.jpg";
import vestidoCorsetNegro2 from "@/assets/vestido-corset-negro-2.jpg";
import vestidoCorsetNegro3 from "@/assets/vestido-corset-negro-3.jpg";
import vestidoEncajeNegro1 from "@/assets/vestido-encaje-negro-1.jpg";
import vestidoEncajeNegro2 from "@/assets/vestido-encaje-negro-2.jpg";
import vestidoEncajeNegro3 from "@/assets/vestido-encaje-negro-3.jpg";

const SIZES = ["S", "M", "L", "XL"];

const DRESSES = [
  { name: "Vestido Corset Blanco con Abertura", image: vestidoCorsetBranco1, description: "Vestido largo tipo corset con abertura lateral" },
  { name: "Vestido Corset Negro Strapless", image: vestidoCorsetNegro1, description: "Vestido largo negro con corset brillante" },
  { name: "Vestido Largo Negro de Encaje", image: vestidoEncajeNegro1, description: "Vestido largo negro con detalle de encaje transparente" },
];
...
const VestidoCorset = () => {
  ...
  const PRODUCT_ID = "VESTIDO-CORSET3-GT";
  const PRODUCT_PRICE = 259;

  const productImages = [
    vestidoCorsetBranco1, vestidoCorsetBranco2, vestidoCorsetBranco3,
    vestidoCorsetNegro1, vestidoCorsetNegro2, vestidoCorsetNegro3,
    vestidoEncajeNegro1, vestidoEncajeNegro2, vestidoEncajeNegro3,
  ];
  ...
  const testimonials = [
    { name: "Fernanda R.", rating: 5, comment: "El vestido corset blanco es espectacular para eventos formales. ¡3 vestidos por Q259 es una oferta increíble!", date: "Hace 2 días" },
    { name: "Mariana L.", rating: 5, comment: "El corset negro con brillos es divino, ideal para fiestas. La calidad de la tela es premium.", date: "Hace 5 días" },
    { name: "Camila H.", rating: 5, comment: "El vestido de encaje negro es súper elegante y sensual. Perfecto para una cena romántica.", date: "Hace 1 semana" },
    { name: "Valeria P.", rating: 5, comment: "3 vestidos hermosos por ese precio es una ganga. Llegaron en 3 días y la calidad superó mis expectativas.", date: "Hace 2 semanas" },
  ];
    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-start">
          <div className="animate-fade-in">
            <div className="rounded-xl sm:rounded-2xl overflow-hidden shadow-large mb-3 sm:mb-4 bg-white relative">
              <img src={productImages[selectedImage]} alt="Vestido Corset Kit 3 en 1" className="w-full h-auto object-cover aspect-[3/4]" />
            </div>
          ...
          <div className="animate-scale-in">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-2">
              ...
              <Badge variant="secondary" className="text-xs font-semibold">+2,000 vendidos!</Badge>
            </div>

            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 text-foreground leading-tight">
              VESTIDO CORSET KIT 3 EN 1 👗🖤
            </h1>
            ...
            <p className="text-sm sm:text-base text-muted-foreground mb-4">
              3 vestidos premium tipo corset para brillar en toda ocasión. Un corset blanco con abertura, un corset negro strapless con brillos y un vestido largo de encaje transparente.
            </p>
            ...
            <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
              {[
                { text: "Kit completo con", bold: "3 vestidos premium tipo corset" },
                { text: "Telas de", bold: "alta calidad: satín, brillos y encaje" },
                { text: "Diseños", bold: "sofisticados para toda ocasión" },
                { text: "Ideales para", bold: "fiestas, galas, bodas y eventos" },
                ...
                <DialogContent className="w-[95vw] max-w-2xl max-h-[95vh] overflow-y-auto p-3 sm:p-6 rounded-xl">
                  ...
                  {showCODForm && (
                    <CODFormGuatemala
                      ...
                      productName={`Vestido Corset Kit 3 en 1 (${sizesNote})`}
                      productImage={vestidoCorsetBranco1}
                      includedItems={[
                        { id: 'warranty', icon: '🛡️', title: 'Garantía', description: 'Protección contra defectos' },
                        { id: 'kit', icon: '👗', title: '3 Vestidos Premium', description: 'Corset Blanco + Corset Negro + Encaje Negro' },
        ...
        <div className="container mx-auto px-3 sm:px-4">
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-6 max-w-3xl mx-auto">
            <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-amber-500/10 to-amber-600/5 border border-amber-500/20 text-center">
              ...
              <h3 className="font-bold text-xs sm:text-base mb-1">Corset Blanco</h3>
              <p className="text-muted-foreground text-[10px] sm:text-xs">Largo con abertura</p>
            </div>
            <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-gray-800/10 to-gray-900/5 border border-gray-500/20 text-center">
              <span className="text-3xl sm:text-4xl mb-3 block">🖤</span>
              <h3 className="font-bold text-xs sm:text-base mb-1">Corset Negro</h3>
              <p className="text-muted-foreground text-[10px] sm:text-xs">Strapless con brillos</p>
            </div>
            <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-purple-500/10 to-purple-600/5 border border-purple-500/20 text-center">
              <span className="text-3xl sm:text-4xl mb-3 block">🕶️</span>
              <h3 className="font-bold text-xs sm:text-base mb-1">Encaje Negro</h3>
              <p className="text-muted-foreground text-[10px] sm:text-xs">Largo transparente</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-16">
        <div className="container mx-auto px-3 sm:px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              { icon: Heart, title: "Diseños Sofisticados", desc: "Corset blanco, corset negro con brillos y encaje transparente: 3 estilos para impactar." },
              { icon: Sparkles, title: "Tela Premium", desc: "Satín, encaje y telas con brillo que se ajustan perfectamente a tu cuerpo." },
              { icon: Flame, title: "Para Toda Ocasión", desc: "Desde galas elegantes hasta fiestas nocturnas. Siempre espectacular." },
              { icon: Zap, title: "Acabados Perfectos", desc: "Costuras reforzadas, corset estructurado y detalles que marcan la diferencia." },
            ].map((item, idx) => (
        ...
        <div className="container mx-auto px-3 sm:px-4 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="text-sm sm:text-base">¡Sí! Por Q259 recibes los 3 vestidos: corset blanco con abertura, corset negro strapless con brillos y vestido largo de encaje negro.</AccordionContent>
            </AccordionItem>
      ...
      <section className="py-10 sm:py-16 bg-gradient-to-r from-pink-700 to-pink-900 text-white">
        <div className="container mx-auto px-3 sm:px-4 text-center">
          ...
          <p className="text-lg sm:text-xl mb-6 opacity-90">Envío gratis + Pago contra entrega + 3 vestidos premium</p>
          <Dialog open={showCODForm} onOpenChange={handleDialogChange}>
            <DialogTrigger asChild>
