...
const VestidoCorset = () => {
  ...
  const testimonials = [
    { name: "Fernanda R.", rating: 5, comment: "El vestido corset blanco es espectacular para eventos formales. ¡3 vestidos por Q299 es una oferta increíble!", date: "Hace 2 días" },
        ...
        <div className="container mx-auto px-3 sm:px-4 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="text-sm sm:text-base">¡Sí! Por Q299 recibes los 3 vestidos: corset blanco con abertura, corset negro strapless con brillos y vestido largo de encaje negro.</AccordionContent>
            </AccordionItem>
