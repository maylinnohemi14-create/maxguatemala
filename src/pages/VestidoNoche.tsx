...
const VestidoNoche = () => {
  ...
  const testimonials = [
    { name: "Andrea M.", rating: 5, comment: "El vestido dorado es espectacular para fiestas. ¡3 vestidos de gala por Q299 es increíble!", date: "Hace 2 días" },
        ...
        <div className="container mx-auto px-3 sm:px-4 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="text-sm sm:text-base">¡Sí! Por Q299 recibes los 3 vestidos de noche: encaje negro, dorado brillante y azul con espalda cruzada.</AccordionContent>
            </AccordionItem>
