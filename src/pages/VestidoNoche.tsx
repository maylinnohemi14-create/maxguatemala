...
import vestidoEncaje1 from "@/assets/vestido-encaje-negro2-1.jpg";
import vestidoEncaje2 from "@/assets/vestido-encaje-negro2-2.jpg";
import vestidoEncaje3 from "@/assets/vestido-encaje-negro2-3.jpg";
import vestidoDorado1 from "@/assets/vestido-dorado-1.jpg";
import vestidoDorado2 from "@/assets/vestido-dorado-2.jpg";
import vestidoDorado3 from "@/assets/vestido-dorado-3.jpg";
import vestidoAzul1 from "@/assets/vestido-azul-1.jpg";
import vestidoAzul2 from "@/assets/vestido-azul-2.jpg";
import vestidoAzul3 from "@/assets/vestido-azul-3.jpg";

const SIZES = ["S", "M", "L", "XL"];

const DRESSES = [
  { name: "Vestido Largo Negro de Encaje", image: vestidoEncaje1, description: "Vestido largo negro con detalle de encaje transparente" },
  { name: "Vestido Largo Dorado Brillante", image: vestidoDorado2, description: "Vestido largo dorado con brillo y detalle torcido" },
  { name: "Vestido Largo Azul con Abertura", image: vestidoAzul2, description: "Vestido largo azul con espalda cruzada y abertura" },
];
...
const VestidoNoche = () => {
  ...
  const PRODUCT_ID = "VESTIDO-NOCHE3-GT";
  const PRODUCT_PRICE = 259;

  const productImages = [
    vestidoEncaje1, vestidoEncaje2, vestidoEncaje3,
    vestidoDorado1, vestidoDorado2, vestidoDorado3,
    vestidoAzul1, vestidoAzul2, vestidoAzul3,
  ];
  ...
  const testimonials = [
    { name: "Andrea M.", rating: 5, comment: "El vestido dorado es espectacular para fiestas. ¡3 vestidos de gala por Q259 es increíble!", date: "Hace 2 días" },
    { name: "Carolina S.", rating: 5, comment: "El azul con espalda cruzada es divino. La tela es de excelente calidad y el corte perfecto.", date: "Hace 5 días" },
    { name: "Daniela R.", rating: 5, comment: "El vestido de encaje negro es súper elegante. Perfecto para eventos formales y cenas.", date: "Hace 1 semana" },
    { name: "Patricia G.", rating: 5, comment: "3 vestidos de noche premium por ese precio es una ganga. Llegaron rápido y son hermosos.", date: "Hace 2 semanas" },
  ];
    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-start">
          <div className="animate-fade-in">
            <div className="rounded-xl sm:rounded-2xl overflow-hidden shadow-large mb-3 sm:mb-4 bg-white relative">
              <img src={productImages[selectedImage]} alt="Vestido Noche Kit 3 en 1" className="w-full h-auto object-cover aspect-[3/4]" />
            </div>
          ...
          <div className="animate-scale-in">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-2">
              ...
              <span className="text-xs sm:text-sm font-medium text-muted-foreground">(190+ reseñas)</span>
              <Badge variant="secondary" className="text-xs font-semibold">+2,200 vendidos!</Badge>
            </div>

            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 text-foreground leading-tight">
              VESTIDO NOCHE KIT 3 EN 1 👗🌙
            </h1>
            ...
            <p className="text-sm sm:text-base text-muted-foreground mb-4">
              3 vestidos de noche premium para brillar en cada evento. Un vestido negro de encaje, un dorado brillante con detalle torcido y un azul elegante con espalda cruzada.
            </p>
            ...
            <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
              {[
                ...
                { text: "Telas de", bold: "alta calidad: encaje, brillo y satín" },
                { text: "Diseños", bold: "elegantes para eventos especiales" },
                { text: "Ideales para", bold: "galas, bodas, fiestas y cenas" },
                ...
                <DialogContent className="w-[95vw] max-w-2xl max-h-[95vh] overflow-y-auto p-3 sm:p-6 rounded-xl">
                  ...
                  {showCODForm && (
                    <CODFormGuatemala
                      ...
                      productName={`Vestido Noche Kit 3 en 1 (${sizesNote})`}
                      productImage={vestidoEncaje1}
                      includedItems={[
                        { id: 'warranty', icon: '🛡️', title: 'Garantía', description: 'Protección contra defectos' },
                        { id: 'kit', icon: '👗', title: '3 Vestidos de Noche', description: 'Encaje Negro + Dorado + Azul' },
        ...
        <div className="container mx-auto px-3 sm:px-4">
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-6 max-w-3xl mx-auto">
            ...
            <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-amber-500/10 to-amber-600/5 border border-amber-500/20 text-center">
              <span className="text-3xl sm:text-4xl mb-3 block">✨</span>
              <h3 className="font-bold text-xs sm:text-base mb-1">Dorado Brillante</h3>
              <p className="text-muted-foreground text-[10px] sm:text-xs">Con detalle torcido</p>
            </div>
            <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-blue-500/10 to-blue-600/5 border border-blue-500/20 text-center">
              <span className="text-3xl sm:text-4xl mb-3 block">💙</span>
              <h3 className="font-bold text-xs sm:text-base mb-1">Azul Elegante</h3>
              <p className="text-muted-foreground text-[10px] sm:text-xs">Espalda cruzada</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-16">
        <div className="container mx-auto px-3 sm:px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              { icon: Heart, title: "Diseños de Gala", desc: "Encaje, brillo y satín: 3 estilos para impactar en cada evento nocturno." },
              { icon: Sparkles, title: "Tela Premium", desc: "Materiales de alta calidad con acabados brillantes y elegantes." },
              { icon: Flame, title: "Para Eventos Especiales", desc: "Galas, bodas, fiestas y cenas románticas. Siempre espectacular." },
        ...
        <div className="container mx-auto px-3 sm:px-4 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="text-sm sm:text-base">¡Sí! Por Q259 recibes los 3 vestidos de noche: encaje negro, dorado brillante y azul con espalda cruzada.</AccordionContent>
            </AccordionItem>
      ...
      <section className="py-10 sm:py-16 bg-gradient-to-r from-pink-700 to-pink-900 text-white">
        <div className="container mx-auto px-3 sm:px-4 text-center">
          ...
          <p className="text-lg sm:text-xl mb-6 opacity-90">Envío gratis + Pago contra entrega + 3 vestidos de noche premium</p>
          <Dialog open={showCODForm} onOpenChange={handleDialogChange}>
            <DialogTrigger asChild>
