...
const ConjuntosCL = () => {
  ...
  useEffect(() => {
    tiktokPixelIds.forEach(pid => {
      trackTikTokConversion('ViewContent', {
        ...
        value: PRODUCT_PRICE, currency: 'CLP', content_category: 'Conjuntos Deportivos',
      }, pid);
    });
    facebookPixelIds.forEach(pid => {
      trackFacebookConversion('ViewContent', {
        content_ids: [PRODUCT_ID], content_type: 'product', content_name: 'Conjuntos Deportivos Kit 3 en 1',
        value: PRODUCT_PRICE, currency: 'CLP'
      }, pid);
    });
  ...
  const handleDialogChange = (open: boolean) => {
    if (open) {
      ...
      facebookPixelIds.forEach(pid => {
        trackFacebookConversion('AddToCart', { content_ids: [PRODUCT_ID], content_type: 'product', value: PRODUCT_PRICE, currency: 'CLP' }, pid);
      });
    }
    setShowCODForm(open);
  };
  ...
  const chileanNames = [
    "María González de Santiago",
    "Carlos Muñoz de Viña del Mar",
    "Ana López de Concepción",
    "José Rodríguez de Valparaíso",
    "Laura Hernández de Temuco",
    "Pedro García de Antofagasta",
    "Rosa Pérez de La Serena",
    "Juan Morales de Rancagua",
    "Carmen Torres de Talca",
    "Luis Castro de Puerto Montt",
    "Sofía Ramírez de Iquique",
    "Diego Gutiérrez de Arica",
  ];

  useEffect(() => {
    const interval = setInterval(() => {
      const randomName = chileanNames[Math.floor(Math.random() * chileanNames.length)];
      toast.success(
        <div>
  ...
  const testimonials = [
    ...
    },
    {
      name: "Fernando L.",
      rating: 5,
      comment: "Llegó rápido a mi casa en Santiago. Los 3 conjuntos son idénticos a la foto. Material premium, costuras reforzadas. Muy recomendado.",
      date: "Hace 2 semanas",
    },
    {
      name: "Karla P.",
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="container mx-auto px-3 sm:px-4 py-6 sm:py-12">
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-start">
          ...
          <div className="animate-scale-in">
            <div className="mb-3">
              <Badge className="bg-red-600 text-white font-bold text-xs sm:text-sm px-3 py-1.5 border-2 border-red-700">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-2">
              ...
              <span className="text-xs sm:text-sm font-medium text-muted-foreground">(280+ reseñas)</span>
              <Badge variant="secondary" className="text-xs font-semibold">+3,858 unidades vendidas!</Badge>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-2 mb-3">
              <Badge className="bg-primary text-primary-foreground font-bold text-xs px-3 py-1.5 animate-pulse-glow">
                ⚡ PROMOCIÓN VÁLIDA HASTA HOY {new Date().toLocaleDateString('es-CL', { timeZone: 'America/Santiago', day: 'numeric', month: 'long' }).toUpperCase()} - ¡NO TE LO PIERDAS!
              </Badge>
            </div>
            ...
            <div className="mb-4 sm:mb-6 p-5 sm:p-6 rounded-2xl bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border-2 border-primary/30 shadow-lg relative overflow-hidden">
              ...
              <div className="relative">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-base sm:text-lg text-muted-foreground line-through decoration-destructive decoration-2">{formatPrice(78000)}</span>
                </div>
                <div className="flex items-baseline gap-3 mb-3">
                  ...
                  <span className="text-lg sm:text-xl font-semibold text-muted-foreground">CLP</span>
                </div>
            ...
            {(() => {
              ...
              const formatDate = (date: Date) => {
                return `${date.getDate()} ${date.toLocaleDateString('es-CL', { month: 'short' }).replace('.', '')}`;
              };
            ...
            <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
              {[
                ...
                { text: "Envío", bold: "100% gratis", suffix: "a todo Chile" },
              ].map((benefit, idx) => (
                  ...
                  {showCODForm && (
                    <CODFormChile
                      ...
                      includedItems={[
                        ...
                        { id: 'envio', icon: '🚚', title: 'Envío Gratis', description: 'A todo Chile' },
                      ]}
                      onOrderComplete={() => {
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3">
              <TrustBadge icon={Truck} title="Envío Gratis" description="En todo Chile" />
      ...
      <section className="py-10 sm:py-16 bg-secondary/30">
        <div className="container mx-auto px-3 sm:px-4">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-10 text-foreground">
            Lo que dicen nuestros clientes en Chile 🇨🇱
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-left text-sm sm:text-base">
                ¿Los 3 conjuntos vienen incluidos por {formatPrice(PRODUCT_PRICE)}?
              </AccordionTrigger>
              <AccordionContent className="text-sm sm:text-base">
                ¡Sí! Por {formatPrice(PRODUCT_PRICE)} recibes los 3 conjuntos completos (Gris, Negro y Azul). Cada conjunto incluye buzo con zípper, camiseta y pantalón.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent className="text-sm sm:text-base">
                Hacemos envíos a todas las regiones de Chile en 3-5 días hábiles con envío completamente gratis. Pagas al recibir tu producto.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
      ...
      <section className="py-10 sm:py-16 bg-gradient-to-r from-gray-800 to-gray-900 text-white">
        <div className="container mx-auto px-3 sm:px-4 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">
            ¡Lleva los 3 conjuntos por solo {formatPrice(PRODUCT_PRICE)}! 👟🇨🇱
          </h2>
      ...
      <div className="bg-secondary/50 py-4">
        <div className="container mx-auto px-3 sm:px-4 text-center">
          <p className="text-xs text-muted-foreground">
            Producto original importado. MAX Chile es distribuidor autorizado de productos deportivos de alta calidad.
