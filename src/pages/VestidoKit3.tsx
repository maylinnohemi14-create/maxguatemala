...
import vestidoRendaCostas from "@/assets/vestido-renda-costas.jpg";
import vestidoBolinhaFrente from "@/assets/vestido-bolinha-frente.jpg";
import vestidoBolinhaCostas from "@/assets/vestido-bolinha-costas.jpg";
import vestidoVerdeFrente from "@/assets/vestido-verde-frente.jpg";
import vestidoVerdeCostas from "@/assets/vestido-verde-costas.jpg";

const SIZES = ["S", "M", "L", "XL"];

const DRESSES = [
  { name: "Vestido Largo de Encaje Blanco", image: vestidoRendaFrente, description: "Elegante vestido largo de encaje con volante" },
  { name: "Vestido Polka Dots Asimétrico", image: vestidoBolinhaFrente, description: "Vestido midi con estampado de lunares" },
  { name: "Mini Vestido Verde Brillante", image: vestidoVerdeFrente, description: "Mini vestido con lentejuelas y brillo" },
];
...
const VestidoKit3 = () => {
  ...
  const PRODUCT_ID = "VESTIDO-KIT3-GT";
  const PRODUCT_PRICE = 259;

  const productImages = [
    vestidoRendaFrente, vestidoRendaCostas,
    vestidoBolinhaFrente, vestidoBolinhaCostas,
    vestidoVerdeFrente, vestidoVerdeCostas,
  ];
  ...
  const testimonials = [
    { name: "Carolina V.", rating: 5, comment: "El vestido de encaje es una obra de arte. Los 3 son hermosos y de excelente calidad. ¡Los amo!", date: "Hace 3 días" },
    { name: "Daniela S.", rating: 5, comment: "El de lunares es mi favorito, súper elegante. Los 3 vestidos por Q259 es una locura. 100% recomendado.", date: "Hace 1 semana" },
    { name: "Patricia G.", rating: 5, comment: "El verde brillante es perfecto para salir de fiesta. Llegaron rápido y la calidad es premium.", date: "Hace 2 semanas" },
    { name: "Alejandra M.", rating: 5, comment: "Pensé que por el precio no iban a ser tan bonitos, pero me sorprendieron. Tela de calidad y ajuste perfecto.", date: "Hace 3 semanas" },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-start">
          <div className="animate-fade-in">
            <div className="rounded-xl sm:rounded-2xl overflow-hidden shadow-large mb-3 sm:mb-4 bg-white relative">
              <img src={productImages[selectedImage]} alt="Vestido Premium Kit 3 en 1" className="w-full h-auto object-cover aspect-[3/4]" />
            </div>
          ...
          <div className="animate-scale-in">
            ...
            <p className="text-sm sm:text-base text-muted-foreground mb-4">
              3 vestidos premium para brillar en toda ocasión. Encaje, lunares y lentejuelas: estilos únicos con telas de alta calidad.
            </p>
            ...
            <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
              {[
                { text: "Kit completo con", bold: "3 vestidos premium exclusivos" },
                { text: "Telas de", bold: "alta calidad: encaje, seda y lentejuelas" },
                ...
                <DialogContent className="w-[95vw] max-w-2xl max-h-[95vh] overflow-y-auto p-3 sm:p-6 rounded-xl">
                  ...
                  {showCODForm && (
                    <CODFormGuatemala
                      ...
                      productName={`Vestido Premium Kit 3 en 1 (${sizesNote})`}
                      productImage={vestidoRendaFrente}
                      includedItems={[
                        { id: 'warranty', icon: '🛡️', title: 'Garantía', description: 'Protección contra defectos' },
                        { id: 'kit', icon: '👗', title: '3 Vestidos Premium', description: 'Encaje + Lunares + Brillante' },
        ...
        <div className="container mx-auto px-3 sm:px-4">
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-6 max-w-3xl mx-auto">
            <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-rose-500/10 to-rose-600/5 border border-rose-500/20 text-center">
              ...
              <h3 className="font-bold text-sm sm:text-base mb-1">Vestido de Encaje</h3>
              <p className="text-muted-foreground text-[10px] sm:text-xs">Largo con volante</p>
            </div>
            <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-amber-500/10 to-amber-600/5 border border-amber-500/20 text-center">
              <span className="text-3xl sm:text-4xl mb-3 block">⚫</span>
              <h3 className="font-bold text-sm sm:text-base mb-1">Vestido Polka Dots</h3>
            ...
            <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-lime-500/10 to-lime-600/5 border border-lime-500/20 text-center">
              <span className="text-3xl sm:text-4xl mb-3 block">✨</span>
              <h3 className="font-bold text-sm sm:text-base mb-1">Mini Vestido Verde</h3>
              <p className="text-muted-foreground text-[10px] sm:text-xs">Con lentejuelas</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-16">
        <div className="container mx-auto px-3 sm:px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              { icon: Heart, title: "Diseños Únicos", desc: "Encaje, lunares y lentejuelas: 3 estilos para cada momento especial." },
        ...
        <div className="container mx-auto px-3 sm:px-4 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="text-sm sm:text-base">¡Sí! Por Q259 recibes los 3 vestidos: vestido largo de encaje blanco, vestido polka dots asimétrico y mini vestido verde brillante.</AccordionContent>
            </AccordionItem>
