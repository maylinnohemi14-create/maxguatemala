    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
        ...
        <div className="container mx-auto px-3 sm:px-4 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-left text-sm sm:text-base">¿Los 3 vestidos vienen incluidos por Q299?</AccordionTrigger>
              <AccordionContent className="text-sm sm:text-base">¡Sí! Por Q299 recibes los 3 vestidos: mini verde con lentejuelas, largo café asimétrico y largo negro de encaje.</AccordionContent>
            </AccordionItem>
      ...
      <section className="py-10 sm:py-16 bg-gradient-to-r from-pink-700 to-pink-900 text-white">
        <div className="container mx-auto px-3 sm:px-4 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">¡Lleva los 3 vestidos por solo Q299! 👗🇬🇹</h2>
