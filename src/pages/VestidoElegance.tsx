...
import vestidoVerde2Costas from "@/assets/vestido-verde2-costas.jpg";
import vestidoMarromFrente from "@/assets/vestido-marrom-frente.jpg";
import vestidoMarromCostas from "@/assets/vestido-marrom-costas.jpg";
import vestidoPretoFrente from "@/assets/vestido-preto-frente.jpg";
import vestidoPretoCostas from "@/assets/vestido-preto-costas.jpg";

const SIZES = ["S", "M", "L", "XL"];

const DRESSES = [
  { name: "Mini Vestido Verde Lentejuelas", image: vestidoVerde2Frente, description: "Mini vestido brillante con escote" },
  { name: "Vestido Largo Café Asimétrico", image: vestidoMarromFrente, description: "Vestido largo con hombro descubierto y abertura" },
  { name: "Vestido Largo Negro de Encaje", image: vestidoPretoFrente, description: "Vestido largo de encaje con escote profundo" },
];

const VestidoElegance = () => {
  ...
  const PRODUCT_ID = "VESTIDO-ELEGANCE-GT";
  const PRODUCT_PRICE = 259;

  const productImages = [
    vestidoVerde2Frente, vestidoVerde2Costas,
    vestidoMarromFrente, vestidoMarromCostas,
    vestidoPretoFrente, vestidoPretoCostas,
  ];
  ...
  const testimonials = [
    { name: "Valeria R.", rating: 5, comment: "El vestido negro de encaje es una joya. Los 3 son espectaculares y la tela es de primera. ¡Me encantaron!", date: "Hace 2 días" },
    { name: "Fernanda C.", rating: 5, comment: "El café con hombro descubierto me queda increíble. Calidad premium por un precio increíble. Super recomendado.", date: "Hace 1 semana" },
    { name: "Camila H.", rating: 5, comment: "El verde con lentejuelas es perfecto para fiestas. Llegó rápido y la calidad superó mis expectativas.", date: "Hace 2 semanas" },
    { name: "Natalia P.", rating: 5, comment: "Los 3 vestidos son preciosos. El ajuste es perfecto y realzan la figura. Los uso para toda ocasión.", date: "Hace 3 semanas" },
  ];
    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-start">
          <div className="animate-fade-in">
            <div className="rounded-xl sm:rounded-2xl overflow-hidden shadow-large mb-3 sm:mb-4 bg-white relative">
              <img src={productImages[selectedImage]} alt="Vestido Elegance Kit 3 en 1" className="w-full h-auto object-cover aspect-[3/4]" />
            </div>
          ...
          <div className="animate-scale-in">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-2">
              ...
              <span className="text-xs sm:text-sm font-medium text-muted-foreground">(200+ reseñas)</span>
              <Badge variant="secondary" className="text-xs font-semibold">+2,100 vendidos!</Badge>
            </div>

            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 text-foreground leading-tight">
              VESTIDO ELEGANCE KIT 3 EN 1 👗✨
            </h1>
            ...
            <p className="text-sm sm:text-base text-muted-foreground mb-4">
              3 vestidos de noche premium: lentejuelas, elegancia clásica y encaje. Diseños que resaltan tu belleza en cada evento especial.
            </p>
            ...
            <div className="mb-4 sm:mb-6 p-5 sm:p-6 rounded-2xl bg-gradient-to-br from-pink-500/10 via-pink-500/5 to-transparent border-2 border-pink-500/30 shadow-lg relative overflow-hidden">
              ...
              <div className="relative">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-base sm:text-lg text-muted-foreground line-through decoration-destructive decoration-2">Q499</span>
                </div>
                <div className="flex items-baseline gap-3 mb-3">
                  <span className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-destructive animate-pulse-scale drop-shadow-sm">Q259</span>
            ...
            <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
              {[
                { text: "Kit completo con", bold: "3 vestidos de noche premium" },
                { text: "Telas de", bold: "alta calidad: lentejuelas, algodón y encaje" },
                { text: "Diseños", bold: "elegantes para eventos y fiestas" },
                { text: "Ideales para", bold: "bodas, galas, cenas y salidas nocturnas" },
                ...
                <DialogContent className="w-[95vw] max-w-2xl max-h-[95vh] overflow-y-auto p-3 sm:p-6 rounded-xl">
                  ...
                  {showCODForm && (
                    <CODFormGuatemala
                      ...
                      productName={`Vestido Elegance Kit 3 en 1 (${sizesNote})`}
                      productImage={vestidoVerde2Frente}
                      includedItems={[
                        { id: 'warranty', icon: '🛡️', title: 'Garantía', description: 'Protección contra defectos' },
                        { id: 'kit', icon: '👗', title: '3 Vestidos Elegance', description: 'Verde + Café + Negro' },
      ...
      <section className="py-10 sm:py-16 bg-secondary/30">
        <div className="container mx-auto px-3 sm:px-4">
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-6 max-w-3xl mx-auto">
            <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-lime-500/10 to-lime-600/5 border border-lime-500/20 text-center">
              <span className="text-3xl sm:text-4xl mb-3 block">💚</span>
              <h3 className="font-bold text-sm sm:text-base mb-1">Mini Verde Lentejuelas</h3>
              <p className="text-muted-foreground text-[10px] sm:text-xs">Brillante y atrevido</p>
            </div>
            <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-amber-800/10 to-amber-900/5 border border-amber-800/20 text-center">
              <span className="text-3xl sm:text-4xl mb-3 block">🤎</span>
              <h3 className="font-bold text-sm sm:text-base mb-1">Largo Café Asimétrico</h3>
              <p className="text-muted-foreground text-[10px] sm:text-xs">Hombro descubierto</p>
            </div>
            <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-gray-800/10 to-gray-900/5 border border-gray-800/20 text-center">
              <span className="text-3xl sm:text-4xl mb-3 block">🖤</span>
              <h3 className="font-bold text-sm sm:text-base mb-1">Largo Negro Encaje</h3>
              <p className="text-muted-foreground text-[10px] sm:text-xs">Escote profundo</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-16">
        <div className="container mx-auto px-3 sm:px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              { icon: Heart, title: "Elegancia Total", desc: "3 estilos sofisticados para brillar en bodas, galas y eventos especiales." },
              { icon: Sparkles, title: "Tela Premium", desc: "Lentejuelas, algodón premium y encaje de alta calidad para un look impecable." },
              { icon: Flame, title: "Ajuste Perfecto", desc: "Diseños que realzan tu figura con cortes estratégicos y telas que se adaptan." },
              { icon: Zap, title: "Versatilidad", desc: "Del coctel a la gala. 3 looks diferentes para cada ocasión especial." },
            ].map((item, idx) => (
        ...
        <div className="container mx-auto px-3 sm:px-4 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-left text-sm sm:text-base">¿Los 3 vestidos vienen incluidos por Q259?</AccordionTrigger>
              <AccordionContent className="text-sm sm:text-base">¡Sí! Por Q259 recibes los 3 vestidos: mini verde con lentejuelas, largo café asimétrico y largo negro de encaje.</AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent className="text-sm sm:text-base">Envíos a toda Guatemala en 3-5 días hábiles con envío gratis. Pagas al recibir.</AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-16 bg-gradient-to-r from-pink-700 to-pink-900 text-white">
        <div className="container mx-auto px-3 sm:px-4 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">¡Lleva los 3 vestidos por solo Q259! 👗🇬🇹</h2>
          <p className="text-lg sm:text-xl mb-6 opacity-90">Envío gratis + Pago contra entrega + 3 vestidos elegance</p>
          <Dialog open={showCODForm} onOpenChange={handleDialogChange}>
            <DialogTrigger asChild>
...
export default VestidoElegance;
