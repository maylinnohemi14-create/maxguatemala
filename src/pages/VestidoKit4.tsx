        ...
        <div className="container mx-auto px-3 sm:px-4 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="text-sm sm:text-base">¡Sí! Por Q259 recibes los 4 vestidos completos: vestido largo amarillo con encaje, vestido largo azul con abertura, vestido dorado espalda abierta y mini vestido azul con estrellas.</AccordionContent>
            </AccordionItem>
