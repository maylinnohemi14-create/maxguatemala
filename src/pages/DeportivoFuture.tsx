...
const DeportivoFuture = () => {
  ...
  // Carousel images: alternate buzo/pantalón across all colors
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="text-white">
            ...
            <p className="text-white/70 text-sm sm:text-base mb-5">
              Buzo zípper + pantalón en tejido premium transpirable. Comodidad para entrenar o vestir casual con envío rápido a toda Guatemala.
            </p>
...
export default DeportivoFuture;
