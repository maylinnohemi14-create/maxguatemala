...
const ConjuntosKit4CO = () => {
  ...
  const handleDialogChange = (open: boolean) => {
    if (open) {
      ...
      facebookPixelIds.forEach(pid => {
        trackFacebookConversion('AddToCart', { content_ids: [PRODUCT_ID], content_type: 'product', value: PRODUCT_PRICE, currency: 'COP' }, pid);
      });
    }
    setShowCODForm(open);
  };
  ...
  const colombianNames = [
    ...
    "Ana Martínez de Cali",
    "José Rodríguez de Barranquilla",
    "Laura Hernández de Cartagena",
    "Pedro González de Bucaramanga",
    "Rosa Pérez de Pereira",
    "Juan Morales de Manizales",
    "Carmen Torres de Cúcuta",
    "Luis Castro de Ibagué",
    "Sofía Ramírez de Villavicencio",
    "Diego Gutiérrez de Santa Marta",
  ];
  ...
  const testimonials = [
    ...
    },
    {
      name: "Fernando L.",
      rating: 5,
      comment: "Llegó rápido a Bogotá. Los 4 conjuntos son idénticos a la foto. Material premium, costuras reforzadas. Muy recomendado.",
      date: "Hace 2 semanas",
    },
    {
      name: "Karla P.",
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden max-w-[100vw]">
      ...
      <div className="w-full bg-white">
        <img src={maxHeader} alt="MAX Colombia - Tienda Online" className="w-full h-auto object-contain sm:object-cover max-h-[120px] sm:max-h-none mx-auto sm:mx-0 p-2 sm:p-0" />
      </div>
      ...
      <section className="container mx-auto px-4 sm:px-4 py-6 sm:py-12 max-w-[100vw]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="animate-scale-in">
            <div className="mb-3">
              <Badge className="bg-yellow-500 text-white font-bold text-xs sm:text-sm px-3 py-1.5 border-2 border-yellow-600">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-3">
              <Badge className="bg-primary text-primary-foreground font-bold text-xs sm:text-sm px-2 sm:px-3 py-1.5 animate-pulse-glow whitespace-normal text-center leading-tight">
                ⚡ PROMOCIÓN VÁLIDA HASTA HOY {new Date().toLocaleDateString('es-CO', { timeZone: 'America/Bogota', day: 'numeric', month: 'long' }).toUpperCase()} - ¡NO TE LO PIERDAS!
              </Badge>
            </div>
            ...
            <div className="mb-4 sm:mb-6 p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border-2 border-primary/30 shadow-lg relative overflow-hidden">
              ...
              <div className="relative">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-base sm:text-lg text-muted-foreground line-through decoration-destructive decoration-2">$358.000</span>
                </div>
            ...
            <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
              {[
                ...
                { text: "Envío", bold: "100% gratis", suffix: "a toda Colombia" },
              ].map((benefit, idx) => (
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3">
              <TrustBadge icon={Truck} title="Envío Gratis" description="En toda Colombia" />
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-left text-sm sm:text-base">
                ¿Los 4 conjuntos vienen incluidos por {formatPrice(PRODUCT_PRICE)}?
              </AccordionTrigger>
              <AccordionContent className="text-sm sm:text-base">
                ¡Sí! Por {formatPrice(PRODUCT_PRICE)} recibes los 4 conjuntos completos (Negro, Blanco, Azul y Gris/Negro). Cada conjunto incluye camiseta y pantaloneta.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-4">
              ...
              <AccordionContent className="text-sm sm:text-base">
                Hacemos envíos a todos los departamentos de Colombia en 3-5 días hábiles con envío completamente gratis. Pagas al recibir tu producto.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
      ...
      <section className="py-10 sm:py-16 bg-gradient-to-r from-gray-800 to-gray-900 text-white">
        <div className="container mx-auto px-3 sm:px-4 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">
            ¡Lleva los 4 conjuntos por solo {formatPrice(PRODUCT_PRICE)}! 👟🇨🇴
          </h2>
      ...
      <div className="bg-secondary/50 py-4">
        <div className="container mx-auto px-3 sm:px-4 text-center">
          <p className="text-xs text-muted-foreground">
            Producto importado de alta calidad. MAX Colombia - Tienda online de productos deportivos premium.
...
export default ConjuntosKit4CO;
