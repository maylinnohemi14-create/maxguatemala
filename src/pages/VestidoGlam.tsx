...
import vestidoBolinha2Costas from "@/assets/vestido-bolinha2-costas.jpg";
import vestidoVinhoFrente from "@/assets/vestido-vinho-frente.jpg";
import vestidoVinhoCostas from "@/assets/vestido-vinho-costas.jpg";
import vestidoBrancoFrente from "@/assets/vestido-branco-frente.jpg";
import vestidoBrancoCostas from "@/assets/vestido-branco-costas.jpg";
import vestidoVinhoMiniFrente from "@/assets/vestido-vinho-mini-frente.jpg";
import vestidoVinhoMiniCostas from "@/assets/vestido-vinho-mini-costas.jpg";

const SIZES = ["S", "M", "L", "XL"];

const DRESSES = [
  { name: "Vestido Polka Dots Asimétrico", image: vestidoBolinha2Frente, description: "Vestido midi elegante con estampado de lunares" },
  { name: "Vestido Largo Vino con Volantes", image: vestidoVinhoFrente, description: "Vestido largo strapless con detalles de volantes" },
  { name: "Vestido Largo Blanco Elegante", image: vestidoBrancoFrente, description: "Vestido largo blanco con detalles transparentes" },
  { name: "Mini Vestido Vino Bodycon", image: vestidoVinhoMiniFrente, description: "Mini vestido ajustado con escote en V" },
];
...
const VestidoGlam = () => {
  ...
  const PRODUCT_ID = "VESTIDO-GLAM4-GT";
  const PRODUCT_PRICE = 259;

  const productImages = [
    vestidoBolinha2Frente, vestidoBolinha2Costas,
    vestidoVinhoFrente, vestidoVinhoCostas,
    vestidoBrancoFrente, vestidoBrancoCostas,
    vestidoVinhoMiniFrente, vestidoVinhoMiniCostas,
  ];
  ...
  const testimonials = [
    { name: "Fernanda R.", rating: 5, comment: "El vestido de lunares es divino, y el vino largo es ideal para eventos. ¡4 vestidos por Q259 es increíble!", date: "Hace 2 días" },
    { name: "Mariana L.", rating: 5, comment: "El blanco es perfecto para una cena elegante. Todos son de excelente calidad. Súper recomendados.", date: "Hace 5 días" },
    { name: "Camila H.", rating: 5, comment: "El mini vestido vino es mi favorito, ideal para salir de fiesta. La tela es premium. ¡Los amo!", date: "Hace 1 semana" },
    { name: "Valeria P.", rating: 5, comment: "4 vestidos hermosos por ese precio es una ganga. Llegaron en 3 días y la calidad superó mis expectativas.", date: "Hace 2 semanas" },
  ];
    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-start">
          <div className="animate-fade-in">
            <div className="rounded-xl sm:rounded-2xl overflow-hidden shadow-large mb-3 sm:mb-4 bg-white relative">
              <img src={productImages[selectedImage]} alt="Vestido Glam Kit 4 en 1" className="w-full h-auto object-cover aspect-[3/4]" />
            </div>
          ...
          <div className="animate-scale-in">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-2">
              ...
              <Badge variant="secondary" className="text-xs font-semibold">+2,500 vendidos!</Badge>
            </div>

            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 text-foreground leading-tight">
              VESTIDO GLAM KIT 4 EN 1 👗🔥
            </h1>
            ...
            <p className="text-sm sm:text-base text-muted-foreground mb-4">
              4 vestidos premium para brillar en toda ocasión. Polka dots, vestido largo vino, blanco elegante y mini bodycon: estilos únicos con telas de alta calidad.
            </p>
            ...
            <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
              {[
                ...
                { text: "Telas de", bold: "alta calidad: seda, mesh y encaje" },
                ...
                <DialogContent className="w-[95vw] max-w-2xl max-h-[95vh] overflow-y-auto p-3 sm:p-6 rounded-xl">
                  ...
                  {showCODForm && (
                    <CODFormGuatemala
                      ...
                      productName={`Vestido Glam Kit 4 en 1 (${sizesNote})`}
                      productImage={vestidoBolinha2Frente}
                      includedItems={[
                        { id: 'warranty', icon: '🛡️', title: 'Garantía', description: 'Protección contra defectos' },
                        { id: 'kit', icon: '👗', title: '4 Vestidos Premium', description: 'Polka Dots + Vino + Blanco + Mini' },
        ...
        <div className="container mx-auto px-3 sm:px-4">
          ...
          <div className="grid grid-cols-4 gap-3 sm:gap-6 max-w-4xl mx-auto">
            <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-amber-500/10 to-amber-600/5 border border-amber-500/20 text-center">
              ...
              <h3 className="font-bold text-xs sm:text-base mb-1">Polka Dots</h3>
              <p className="text-muted-foreground text-[10px] sm:text-xs">Midi asimétrico</p>
            </div>
            <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-rose-500/10 to-rose-600/5 border border-rose-500/20 text-center">
              <span className="text-3xl sm:text-4xl mb-3 block">🍷</span>
              <h3 className="font-bold text-xs sm:text-base mb-1">Vestido Vino</h3>
              <p className="text-muted-foreground text-[10px] sm:text-xs">Largo con volantes</p>
            </div>
            <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-slate-500/10 to-slate-600/5 border border-slate-500/20 text-center">
              ...
              <p className="text-muted-foreground text-[10px] sm:text-xs">Largo elegante</p>
            </div>
            <div className="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-purple-500/10 to-purple-600/5 border border-purple-500/20 text-center">
              <span className="text-3xl sm:text-4xl mb-3 block">💃</span>
              <h3 className="font-bold text-xs sm:text-base mb-1">Mini Vino</h3>
              <p className="text-muted-foreground text-[10px] sm:text-xs">Bodycon ajustado</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-16">
        <div className="container mx-auto px-3 sm:px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              { icon: Heart, title: "Diseños Únicos", desc: "Polka dots, volantes, transparencias y bodycon: 4 estilos para cada momento especial." },
        ...
        <div className="container mx-auto px-3 sm:px-4 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-left text-sm sm:text-base">¿Los 4 vestidos vienen incluidos por Q259?</AccordionTrigger>
              <AccordionContent className="text-sm sm:text-base">¡Sí! Por Q259 recibes los 4 vestidos: polka dots, vestido largo vino con volantes, vestido largo blanco elegante y mini vestido vino bodycon.</AccordionContent>
            </AccordionItem>
      ...
      <section className="py-10 sm:py-16 bg-gradient-to-r from-pink-700 to-pink-900 text-white">
        <div className="container mx-auto px-3 sm:px-4 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">¡Lleva los 4 vestidos por solo Q259! 👗🇬🇹</h2>
