...
const VestidoGlam = () => {
  ...
  const testimonials = [
    { name: "Fernanda R.", rating: 5, comment: "El vestido de lunares es divino, y el vino largo es ideal para eventos. ¡4 vestidos por Q279 es increíble!", date: "Hace 2 días" },
        ...
        <div className="container mx-auto px-3 sm:px-4 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="text-sm sm:text-base">¡Sí! Por Q279 recibes los 4 vestidos: polka dots, vestido largo vino con volantes, vestido largo blanco elegante y mini vestido vino bodycon.</AccordionContent>
            </AccordionItem>
