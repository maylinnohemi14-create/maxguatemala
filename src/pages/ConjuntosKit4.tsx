...
const C_BLACK = "#05080F";
const C_DARK = "#0B1322";
const C_CYAN = "#00E5FF";
const C_MAGENTA = "#FF2E9A";
...
const SET_SIZE_GUIDE = [
  { size: "XS", pecho: "82-86", cintura: "66-70", cadera: "82-86" },
  { size: "S", pecho: "86-92", cintura: "70-76", cadera: "86-92" },
  { size: "M", pecho: "92-98", cintura: "76-82", cadera: "92-98" },
  { size: "L", pecho: "98-104", cintura: "82-88", cadera: "98-104" },
  { size: "XL", pecho: "104-112", cintura: "88-96", cadera: "104-112" },
  { size: "XXL", pecho: "112-120", cintura: "96-104", cadera: "112-120" },
  { size: "XXXL", pecho: "120-128", cintura: "104-112", cadera: "120-128" },
];
...
type SetItem = { id: string; name: string; image: string };

const SETS: SetItem[] = [
  { id: "negro", name: "Conjunto Negro", image: conjunto4Negro },
  { id: "blanco", name: "Conjunto Blanco", image: conjunto4Blanco },
  { id: "azul", name: "Conjunto Azul", image: conjunto4Azul },
  { id: "gris", name: "Conjunto Gris/Negro", image: conjunto4Gris },
];
...
const ConjuntosKit4 = () => {
  ...
  const [topSizes, setTopSizes] = useState<Record<number, string>>({ 0: "M", 1: "M", 2: "M", 3: "M" });
  const [bottomSizes, setBottomSizes] = useState<Record<number, string>>({ 0: "M", 1: "M", 2: "M", 3: "M" });
  ...
  const carouselImages = useMemo(
    () => [
      { src: conjuntoPrincipal, name: "Kit 4 en 1 Completo" },
      { src: conjunto4Negro, name: "Conjunto Negro" },
      { src: conjunto4Blanco, name: "Conjunto Blanco" },
      { src: conjunto4Azul, name: "Conjunto Azul" },
      { src: conjunto4Gris, name: "Conjunto Gris/Negro" },
    ],
    []
  );
  ...
  useEffect(() => {
    tiktokPixelIds.forEach((pid) => {
      trackTikTokConversion(
        "ViewContent",
        {
          contents: [{ content_id: PRODUCT_ID, content_type: "product", content_name: "Conjuntos Deportivos Kit 4 en 1", quantity: 1, price: PRODUCT_PRICE }],
          value: PRODUCT_PRICE,
          currency: "GTQ",
  ...
  const sizesNote = useMemo(
    () =>
      SETS.map(
        (s, idx) => `${s.name}: Camiseta ${topSizes[idx]} / Pantaloneta ${bottomSizes[idx]}`
      ).join(" | "),
    [topSizes, bottomSizes]
  );

  const productDisplayName = "Conjuntos Deportivos Kit 4 en 1";
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(${C_CYAN}33 1px, transparent 1px), linear-gradient(90deg, ${C_CYAN}33 1px, transparent 1px)`,
      ...
      <div
        ...
        style={{ background: C_MAGENTA, animationDelay: "1.5s" }}
      />
        ...
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div
              ...
              style={{
                background: `linear-gradient(135deg, ${C_CYAN}, ${C_MAGENTA})`,
                boxShadow: `0 0 20px ${C_CYAN}66`,
              }}
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          <div className="relative">
            <div
              ...
              style={{
                borderColor: `${C_CYAN}55`,
                background: `linear-gradient(160deg, ${C_GRAY}, #000)`,
                boxShadow: `0 20px 60px -20px ${C_CYAN}aa`,
              }}
            >
              <div
                className="absolute top-6 -right-12 z-20 w-48 text-center py-1.5 text-[11px] font-black tracking-widest text-white rotate-45"
                style={{
                  background: `linear-gradient(90deg, ${C_MAGENTA}, ${C_CYAN})`,
                  boxShadow: `0 4px 16px ${C_MAGENTA}66`,
                }}
              >
                💰 PAGO AL RECIBIR
              </div>
              ...
              <img
                ...
                alt={`Kit 4 en 1 ${carouselImages[selectedImage].name}`}
                ...
                <div className="flex gap-1.5">
                  {carouselImages.map((_, i) => (
                    <button
                      ...
                      style={{
                        background: i === selectedImage ? C_CYAN : "rgba(255,255,255,0.3)",
            ...
            <div className="mt-3 grid grid-cols-5 gap-1.5">
              {carouselImages.map((c, i) => (
                <button
                  ...
                  style={{
                    borderColor: i === selectedImage ? C_CYAN : "rgba(255,255,255,0.1)",
                    boxShadow: i === selectedImage ? `0 0 12px ${C_CYAN}88` : "none",
                  }}
                >
          ...
          <div className="text-white">
            <div
              ...
              style={{ borderColor: `${C_CYAN}66`, background: `${C_CYAN}15` }}
            >
              <Sparkles className="w-3.5 h-3.5" style={{ color: C_CYAN }} />
              <span className="text-[11px] font-bold tracking-widest" style={{ color: C_CYAN }}>
            ...
            <h1 className="text-3xl sm:text-5xl font-black leading-[0.95] tracking-tight mb-3">
              ...
              <span
                style={{
                  background: `linear-gradient(135deg, ${C_CYAN} 0%, ${C_MAGENTA} 100%)`,
            ...
            <p className="text-white/70 text-sm sm:text-base mb-5">
              Camiseta + Pantaloneta en tejido premium transpirable. Recibes los 4 conjuntos completos (Negro, Blanco, Azul y Gris) con envío gratis a toda Guatemala.
            </p>
            ...
            <div className="flex items-center gap-2 mb-5 px-3 py-2 rounded-lg border border-white/10 bg-white/5 backdrop-blur w-fit">
              ...
              <span className="text-xs text-white/80 font-medium">14 personas viendo ahora · Solo {stockCount} kits disponibles</span>
            </div>
            ...
            <div
              ...
              style={{
                borderColor: `${C_CYAN}55`,
                background: `linear-gradient(135deg, ${C_CYAN}11, ${C_MAGENTA}08)`,
                boxShadow: `0 0 32px ${C_CYAN}33`,
              }}
            >
              <div
                className="absolute top-0 right-0 px-3 py-1 text-[10px] font-black tracking-widest rounded-bl-xl"
                style={{ background: C_CYAN, color: "#000" }}
              >
                🔥 OFERTA ACTIVA
              </div>
              ...
              <div className="text-xs text-white/60 mt-2">Por los 4 conjuntos completos · Pago al recibir</div>
            </div>
              ...
              <div className="flex items-center justify-between text-xs">
                <div className="flex flex-col items-center text-center flex-1">
                  <div
                    ...
                    style={{ background: `${C_CYAN}22`, border: `1.5px solid ${C_CYAN}` }}
                  >
                ...
                <div className="flex flex-col items-center text-center flex-1">
                  <div
                    className="w-9 h-9 rounded-full flex items-center justify-center mb-1.5"
                    style={{ background: `${C_MAGENTA}22`, border: `1.5px solid ${C_MAGENTA}` }}
                  >
              ...
              <div className="space-y-2">
                {SETS.map((set, idx) => (
                  ...
                  >
                        ...
                        {SIZES.map((s) => {
                          ...
                          return (
                            <button
                              ...
                              style={{
                                borderColor: active ? C_CYAN : "rgba(255,255,255,0.12)",
                                background: active ? C_CYAN : "transparent",
                                color: active ? "#000" : "#fff",
                                boxShadow: active ? `0 0 8px ${C_CYAN}88` : "none",
                              }}
                            >
                              {s}
                            </button>
                    ...
                    <div>
                      <div className="text-[10px] font-bold uppercase tracking-wider text-white/50 mb-1">Pantaloneta</div>
                      <div className="grid grid-cols-7 gap-1">
                        {SIZES.map((s) => {
                          ...
                          return (
                            <button
                              ...
                              className="py-1.5 rounded-md text-[11px] font-black transition-all border"
                              style={{
                                borderColor: active ? C_MAGENTA : "rgba(255,255,255,0.12)",
                                background: active ? C_MAGENTA : "transparent",
                                color: active ? "#fff" : "#fff",
                                boxShadow: active ? `0 0 8px ${C_MAGENTA}88` : "none",
                              }}
                            >
                              {s}
                            </button>
            ...
            <Button
              ...
              style={{
                background: `linear-gradient(135deg, ${C_CYAN}, ${C_MAGENTA})`,
                color: "#fff",
                boxShadow: `0 12px 32px -8px ${C_CYAN}, inset 0 1px 0 ${C_WHITE}33`,
              }}
            >
            ...
            <div className="grid grid-cols-3 gap-2 mt-4 text-center">
              {[
                ...
                >
                  <span style={{ color: C_CYAN }}>{t.i}</span>
        ...
        <section ref={formRef} className="relative z-10 max-w-3xl mx-auto px-4 pb-16">
          <div
            ...
            style={{
              ...
              boxShadow: `0 20px 60px -10px ${C_CYAN}88`,
            }}
          >
            <div className="text-center mb-5">
              <div
                className="inline-flex items-center gap-2 px-3 py-1 rounded-full mb-3"
                style={{ background: `${C_CYAN}22`, border: `1px solid ${C_CYAN}55` }}
              >
                <span style={{ color: C_MAGENTA }} className="text-xs font-bold tracking-widest">
                  ✦ ÚLTIMO PASO ✦
                </span>
              </div>
            ...
            <CODFormGuatemala
              ...
              productImage={conjuntoPrincipal}
      ...
      <Dialog open={showUpsell} onOpenChange={(open) => { if (!open) handleUpsellClose(); }}>
        <DialogContent
          ...
          style={{
            background: `linear-gradient(160deg, ${C_DARK}, ${C_BLACK})`,
            boxShadow: `0 30px 80px ${C_CYAN}55`,
          }}
        >
          <div className="relative p-5 sm:p-6" style={{ borderTop: `3px solid ${C_CYAN}` }}>
            <div
            ...
            <button
              ...
              style={{
                background: `radial-gradient(circle, ${C_CYAN} 0%, ${C_MAGENTA} 100%)`,
                boxShadow: `0 0 16px ${C_CYAN}, 0 0 32px ${C_CYAN}99, 0 0 48px ${C_MAGENTA}66, inset 0 0 8px rgba(255,255,255,0.3)`,
            ...
            <DialogHeader className="relative z-10">
              <div
                ...
                style={{ borderColor: `${C_CYAN}66`, background: `${C_CYAN}15` }}
              >
                <Flame className="w-3.5 h-3.5" style={{ color: C_CYAN }} />
                <span className="text-[11px] font-black tracking-widest" style={{ color: C_CYAN }}>
                  REGALO EXCLUSIVO
                </span>
              </div>
              <DialogTitle className="text-center text-white text-xl sm:text-2xl font-black leading-tight">
                ...
                <span style={{ color: C_CYAN }}>100% GRATIS</span> 🎁
              </DialogTitle>
            </DialogHeader>
              ...
              >
                <div className="aspect-square relative bg-white">
                  ...
                  >
                    ...
                    <span style={{ color: C_CYAN }}>GRATIS</span>
                  </div>
                </div>
              </div>
                  ...
                  {SHIRT_SIZES.map((s) => {
                    ...
                    return (
                      <button
                        ...
                        style={{
                          borderColor: active ? C_CYAN : "rgba(255,255,255,0.15)",
                          background: active ? C_CYAN : "transparent",
                          color: active ? "#000" : "#fff",
                          boxShadow: active ? `0 0 12px ${C_CYAN}88` : "none",
                        }}
                      >
                        {s}
                      </button>
              ...
              <div className="space-y-2">
                <Button
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${C_CYAN}, ${C_MAGENTA})`,
                    color: "#fff",
                    boxShadow: `0 8px 24px -4px ${C_CYAN}`,
                  }}
                >
          ...
          <div className="relative p-5 sm:p-6" style={{ borderTop: `3px solid ${C_CYAN}` }}>
            ...
            <DialogHeader className="relative z-10">
              <div
                ...
                style={{ borderColor: `${C_CYAN}66`, background: `${C_CYAN}15` }}
              >
                <Ruler className="w-3.5 h-3.5" style={{ color: C_CYAN }} />
                <span className="text-[11px] font-black tracking-widest" style={{ color: C_CYAN }}>
                  GUÍA DE TALLAS
                </span>
              </div>
            ...
            <div className="relative z-10 mt-5">
              <div className="mb-5">
                <div className="text-xs font-black uppercase tracking-widest mb-2" style={{ color: C_CYAN }}>
                  📏 Conjunto Deportivo
                </div>
                <div className="rounded-xl overflow-hidden border" style={{ borderColor: `${C_CYAN}33` }}>
                  <table className="w-full text-xs">
                    <thead>
                      <tr style={{ background: `${C_CYAN}22` }}>
                    ...
                    <tbody>
                      {SET_SIZE_GUIDE.map((row, i) => (
                        <tr key={row.size} style={{ background: i % 2 === 0 ? "rgba(255,255,255,0.02)" : "rgba(255,255,255,0.05)" }}>
                          <td className="py-2 px-2 font-black" style={{ color: C_CYAN }}>{row.size}</td>
              ...
              <div className="rounded-lg p-3 text-[11px] text-white/70 border" style={{ borderColor: `${C_CYAN}33`, background: `${C_CYAN}10` }}>
