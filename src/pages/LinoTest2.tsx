...
const PAGE_ROUTE = "/guatemalaexpressteste";
...
const COLORS: Color[] = [
  { id: "beige", name: "Beige", hex: "#EFE6CF", image: linoBeige, pantalon: linoBeige },
  { id: "verde", name: "Verde", hex: "#9DB18E", image: linoVerde, pantalon: linoVerde },
  { id: "negro", name: "Negro", hex: "#1A1A1A", image: linoNegro, pantalon: linoNegro },
];
...
const QTY_OPTIONS: QtyOption[] = [
  { qty: 1, price: 240, label: "1 Conjunto Premium", saving: 0 },
  { qty: 2, price: 279, label: "2 Conjuntos Premium", saving: 201, highlight: true },
  { qty: 3, price: 299, label: "3 Conjuntos Premium", saving: 421 },
];
...
const Lino = () => {
  ...
  // Carousel images: one per color (single image for both pieces)
  const carouselImages = useMemo(() => {
    const imgs: { src: string; name: string }[] = [];
    COLORS.forEach((c) => {
      imgs.push({ src: c.image, name: `${c.name} · Conjunto` });
    });
    return imgs;
  }, []);
  ...
  // Sync setSizes length with selectedQty
  useEffect(() => {
    setSetSizes((prev) => {
      const next = [...prev];
  ...
  const finalPrice = basePrice + (addShirt ? SHIRT_PRICE : 0);
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-lg sm:text-xl font-black tracking-tight text-white">
                Conjunto Premium <span style={{ color: NIKE_ORANGE }}>·</span> Lino
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="relative">
            ...
            >
              ...
              <img
                ...
                alt={`Conjunto Premium en Lino ${carouselImages[selectedImage].name}`}
          ...
          <div className="text-white">
            ...
            <p className="text-white/70 text-sm sm:text-base mb-5">
              Camisa de botones + pantalón en lino premium ultra fresco. Elegancia casual perfecta para el clima cálido, con envío rápido a toda Guatemala.
            </p>
