...
const ConjuntosCO = () => {
  ...
  const testimonials = [
    ...
    },
    {
      name: "Fernando L.",
      rating: 5,
      comment: "Llegó rápido a Bogotá. Los 3 conjuntos son idénticos a la foto. Material premium, costuras reforzadas. Muy recomendado.",
      date: "Hace 2 semanas",
    },
    {
      name: "Karla P.",
            ...
            <div className="mb-4 sm:mb-6 p-5 sm:p-6 rounded-2xl bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border-2 border-primary/30 shadow-lg relative overflow-hidden">
              ...
              <div className="relative">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-base sm:text-lg text-muted-foreground line-through decoration-destructive decoration-2">$298.000</span>
                </div>
      ...
      <div className="bg-secondary/50 py-4">
        <div className="container mx-auto px-3 sm:px-4 text-center">
          <p className="text-xs text-muted-foreground">
            Producto original importado. MAX Colombia es distribuidor autorizado de productos deportivos de alta calidad.
